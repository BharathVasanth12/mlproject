...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        """
            This function is responsible for for data transformation
        """
        try:
            ...
            logging.info("Numeric columns standard scaling complete")
            logging.info("Categorical columns encoding complete")

            preprocessor = ColumnTransformer(transformers = [("num_pipeline", num_pipeline, numeric_columns), 
